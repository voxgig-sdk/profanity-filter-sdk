...
describe("PlainDirect", function()
  it("should direct-load-plain", function()
    local setup = plain_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-plain", setup.live and "live" or "unit")
...
function plain_direct_setup(mockres)
