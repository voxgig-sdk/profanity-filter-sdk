...
describe("ContainsprofanityDirect", function()
  it("should direct-load-containsprofanity", function()
    local setup = containsprofanity_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-containsprofanity", setup.live and "live" or "unit")
...
function containsprofanity_direct_setup(mockres)
