...
describe("XmlDirect", function()
  it("should direct-load-xml", function()
    local setup = xml_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-xml", setup.live and "live" or "unit")
...
function xml_direct_setup(mockres)
