...
local SDK_MODULE = "profanity-filter_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["containsprofanity"] = { ["test01"] = { id = "test01" } }, ["json"] = { ["test01"] = { id = "test01" } }, ["plain"] = { ["test01"] = { id = "test01" } }, ["xml"] = { ["test01"] = { id = "test01" } } } }'
