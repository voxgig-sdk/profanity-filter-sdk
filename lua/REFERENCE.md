...
```lua
local result, err = client:Containsprofanity():load({ text = "text" })
```
...
```lua
local result, err = client:Json():load({ text = "text" })
```
...
```lua
local result, err = client:Plain():load({ text = "text" })
```
...
```lua
local result, err = client:Xml():load({ text = "text" })
```
