...
local ContainsprofanityEntity = {}
ContainsprofanityEntity.__index = ContainsprofanityEntity


function ContainsprofanityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContainsprofanityEntity)
  self._name = "containsprofanity"
  self._client = client
...
function ContainsprofanityEntity:get_name()
  return self._name
end


function ContainsprofanityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContainsprofanityEntity.new(self._client, opts)
end
...
function ContainsprofanityEntity:mark_deleted()
  self._deleted = true
end


function ContainsprofanityEntity:deleted()
  return true == self._deleted
end


function ContainsprofanityEntity:data_set(args)
  if args ~= nil then
...
function ContainsprofanityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContainsprofanityEntity:match_set(args)
  if args ~= nil then
...
function ContainsprofanityEntity:match_get()
...
function ContainsprofanityEntity:stream(action, args, callopts)
...
---@param reqmatch ContainsprofanityLoadMatch
---@param ctrl? table
---@return Containsprofanity
---@return string? err
function ContainsprofanityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ContainsprofanityEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContainsprofanityEntity
