...
|---|---|---|
| `ts/` | @voxgig-sdk/profanity-filter-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/profanity-filter-sdk \
      --repository voxgig-sdk/profanity-filter-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/profanity-filter-sdk` shows it, and
`npm trust revoke @voxgig-sdk/profanity-filter-sdk --id=<id>` removes it.
