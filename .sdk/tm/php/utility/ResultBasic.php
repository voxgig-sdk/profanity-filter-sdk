...
// ProfanityFilter SDK utility: result_basic

class ProfanityFilterResultBasic
{
    public static function call(ProfanityFilterContext $ctx): ?ProfanityFilterResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ProfanityFilterError) ? $result->err->msg : (string)$result->err;
