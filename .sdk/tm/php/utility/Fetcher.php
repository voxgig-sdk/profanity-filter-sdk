...
// ProfanityFilter SDK utility: fetcher

class ProfanityFilterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ProfanityFilterSDK/1.0)';
    ...
    public static function call(ProfanityFilterContext $ctx, string $fullurl, array $fetchdef): array
    {
