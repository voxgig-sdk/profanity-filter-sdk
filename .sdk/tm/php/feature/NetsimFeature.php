...
// ProfanityFilter SDK netsim feature
...
class ProfanityFilterNetsimFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _simulate(ProfanityFilterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ProfanityFilterContext $ctx, array $applied): void
    {
        $client = $this->client;
