...
// ProfanityFilter SDK ratelimit feature
...
class ProfanityFilterRatelimitFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _acquire(ProfanityFilterContext $ctx): void
    {
    ...
    private function _track(ProfanityFilterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
