...
// ProfanityFilter SDK audit feature
...
class ProfanityFilterAuditFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _emit(ProfanityFilterContext $ctx, string $outcome): void
    {
