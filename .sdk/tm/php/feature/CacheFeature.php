...
// ProfanityFilter SDK cache feature
...
class ProfanityFilterCacheFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _through(ProfanityFilterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
