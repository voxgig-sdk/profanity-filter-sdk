...
// ProfanityFilter SDK rbac feature
...
class ProfanityFilterRbacFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _required(ProfanityFilterContext $ctx): ?string
    {
    ...
    private function _reject(ProfanityFilterContext $ctx, string $required): void
    {
    ...
    private function _track(ProfanityFilterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
