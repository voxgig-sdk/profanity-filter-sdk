...
class ProfanityFilterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ProfanityFilterTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ProfanityFilterTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ProfanityFilterTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
