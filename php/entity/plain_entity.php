...
// ProfanityFilter SDK Plain entity
...
class PlainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PlainEntity($this->_client, $opts);
    }

    /**
     * @param Plain|array $args Plain data (assoc-array) to store.
     */
    ...
    /**
     * @return Plain|array The current Plain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Plain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Plain fields).
     */
     ...
     * Load a single Plain.
     *
     * @param PlainLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PlainLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Plain|array The loaded Plain as an assoc-array at the
