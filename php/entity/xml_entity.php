...
// ProfanityFilter SDK Xml entity
...
class XmlEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new XmlEntity($this->_client, $opts);
    }

    /**
     * @param Xml|array $args Xml data (assoc-array) to store.
     */
    ...
    /**
     * @return Xml|array The current Xml data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Xml fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Xml fields).
     */
     ...
     * Load a single Xml.
     *
     * @param XmlLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed XmlLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Xml|array The loaded Xml as an assoc-array at the
