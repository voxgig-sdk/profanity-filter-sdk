...
class PlainDirectTest extends TestCase
{
    public function test_direct_load_plain(): void
    {
        $setup = plain_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-plain", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
