...
class XmlDirectTest extends TestCase
{
    public function test_direct_load_xml(): void
    {
        $setup = xml_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-xml", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
