...
// ProfanityFilter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ProfanityFilterSDK::test)
...
{
    private const SDK_CLASS = 'ProfanityFilterSDK';
    ...
    private const SDK_BASE = 'profanityfilter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../profanityfilter_sdk.php';
