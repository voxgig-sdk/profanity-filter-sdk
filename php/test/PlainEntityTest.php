...
class PlainEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PROFANITY_FILTER_TEST_PLAIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function plain_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PROFANITY_FILTER_TEST_PLAIN_ENTID");
