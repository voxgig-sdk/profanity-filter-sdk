...
// ProfanityFilter SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ProfanityFilterOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ProfanityFilterOmni::structfix($now, Struct::undef()))
                        !== json_encode(ProfanityFilterOmni::structfix($val, Struct::undef()))) {
