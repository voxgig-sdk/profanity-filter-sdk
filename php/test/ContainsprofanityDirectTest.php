...
class ContainsprofanityDirectTest extends TestCase
{
    public function test_direct_load_containsprofanity(): void
    {
        $setup = containsprofanity_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-containsprofanity", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
