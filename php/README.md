# ProfanityFilter PHP SDK

The PHP SDK for the ProfanityFilter API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Containsprofanity(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ProfanityFilter(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── profanityfilter_sdk.php          -- Main SDK class
...
The main class (`profanityfilter_sdk.php`) exports the SDK class
