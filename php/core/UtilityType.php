...
// ProfanityFilter SDK utility type

class ProfanityFilterUtility
{
    ...
    public static function copy(ProfanityFilterUtility $src): ProfanityFilterUtility
    {
        $u = new ProfanityFilterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
