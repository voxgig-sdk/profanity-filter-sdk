...
// ProfanityFilter SDK timeout feature
...
class ProfanityFilterTimeoutFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _with_timeout(ProfanityFilterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ProfanityFilterContext $_ctx, float $ms): void
    {
        $client = $this->client;
