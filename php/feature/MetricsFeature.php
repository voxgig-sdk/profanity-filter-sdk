...
// ProfanityFilter SDK metrics feature
...
class ProfanityFilterMetricsFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _record(ProfanityFilterContext $ctx, bool $ok): void
    {
