...
// ProfanityFilter SDK telemetry feature
...
class ProfanityFilterTelemetryFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _close(ProfanityFilterContext $ctx, bool $ok): void
    {
