...
// ProfanityFilter SDK streaming feature
...
class ProfanityFilterStreamingFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _iterate(ProfanityFilterResult $result): \Generator
    {
    ...
    private function _streamable(ProfanityFilterContext $ctx): bool
    {
