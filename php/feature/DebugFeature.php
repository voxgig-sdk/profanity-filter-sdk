...
// ProfanityFilter SDK debug feature
...
class ProfanityFilterDebugFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _finish(ProfanityFilterContext $ctx, bool $ok): void
    {
