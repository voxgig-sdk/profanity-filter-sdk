...
// ProfanityFilter SDK idempotency feature
...
class ProfanityFilterIdempotencyFeature extends ProfanityFilterBaseFeature
{
    ...
    private function _mutating(ProfanityFilterContext $ctx): bool
    {
