...
// ProfanityFilter SDK clienttrack feature
...
class ProfanityFilterClienttrackFeature extends ProfanityFilterBaseFeature
{
    ...
    public function PostConstruct(ProfanityFilterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ProfanityFilter-SDK';
