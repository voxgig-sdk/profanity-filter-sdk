...
// ProfanityFilter SDK proxy feature
...
class ProfanityFilterProxyFeature extends ProfanityFilterBaseFeature
{
    ...
    public function init(ProfanityFilterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ProfanityFilterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
