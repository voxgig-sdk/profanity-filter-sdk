...
// ProfanityFilter SDK utility: graphql
//
...
class ProfanityFilterGraphql
{
    ...
    // equivalent.
    public static function body(ProfanityFilterContext $ctx): mixed
    {
    ...
    public static function errors(ProfanityFilterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
