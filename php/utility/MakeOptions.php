...
// ProfanityFilter SDK utility: make_options

class ProfanityFilterMakeOptions
{
    ...
    public static function call(ProfanityFilterContext $ctx): array
    {
        ...
        //
        // `ProfanityFilterSchema::optspec()` is built from the model:
        ...
        $optspec = ProfanityFilterSchema::optspec();
