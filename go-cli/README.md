...
AQL-driven CLI and REPL for the ProfanityFilter SDK. Positional arguments are
...
```sh
go build -o profanity-filter-cli ./...
```
...
./profanity-filter-cli list containsprofanity
./profanity-filter-cli load 1 containsprofanity
./profanity-filter-cli load '{id:1}' containsprofanity
