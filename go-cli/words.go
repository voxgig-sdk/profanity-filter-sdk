...
func registerSDKWords(r *eng.Registry, client *sdk.ProfanityFilterSDK) {
...
func runOp(client *sdk.ProfanityFilterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
