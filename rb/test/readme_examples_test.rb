...
#      offline in seeded test mode (ProfanityFilterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ProfanityFilter_sdk.rb")
  SDK_CLASS = "ProfanityFilterSDK"
