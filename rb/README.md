...
The Ruby SDK for the ProfanityFilter API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `ProfanityFilterError` (a `StandardError` subclass), so wrap
