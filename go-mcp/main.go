// Command ProfanityFilter-mcp is an MCP server exposing the ProfanityFilter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ProfanityFilter_list  — list records of an entity
//	ProfanityFilter_load  — load a single record of an entity
//
