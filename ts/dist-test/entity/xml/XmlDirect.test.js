...
(0, node_test_1.describe)('XmlDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-xml', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-xml', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'PROFANITY_FILTER_TEST_XML_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['PROFANITY_FILTER_TEST_XML_ENTID'];
...
//# sourceMappingURL=XmlDirect.test.js.map