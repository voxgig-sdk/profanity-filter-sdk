...
(0, node_test_1.describe)('XmlEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'xml.' + op, live))
                return;
        }
        ...
        let xml_ref01_data = Object.values(setup.data.existing.xml)[0];
        // LOAD
        const xml_ref01_ent = client.Xml();
        const xml_ref01_match_dt0 = {};
        const xml_ref01_data_dt0 = (await xml_ref01_ent.load(xml_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != xml_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/xml/XmlTestData.json');
    ...
    let idmap = transform(['xml01', 'xml02', 'xml03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['PROFANITY_FILTER_TEST_XML_ENTID'];
...
//# sourceMappingURL=XmlEntity.test.js.map