...
(0, node_test_1.describe)('PlainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-plain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-plain', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PROFANITY_FILTER_TEST_PLAIN_ENTID'];
...
//# sourceMappingURL=PlainDirect.test.js.map