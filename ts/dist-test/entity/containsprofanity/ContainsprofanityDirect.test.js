...
(0, node_test_1.describe)('ContainsprofanityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ProfanityFilterSDK({
    ...
    (0, node_test_1.test)('direct-load-containsprofanity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-containsprofanity', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PROFANITY_FILTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ProfanityFilterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PROFANITY_FILTER_TEST_CONTAINSPROFANITY_ENTID'];
    ...
    const client = new __1.ProfanityFilterSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ContainsprofanityDirect.test.js.map