# ProfanityFilter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ProfanityFilterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ProfanityFilterSDK(...) and ProfanityFilterSDK.test(...) become
#      ProfanityFilterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "profanityfilter_sdk"
_SDK_CLASS = "ProfanityFilterSDK"
