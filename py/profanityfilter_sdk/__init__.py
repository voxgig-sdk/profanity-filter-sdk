...
from profanityfilter_sdk.utility import register

# Load features
from profanityfilter_sdk.feature.base_feature import ProfanityFilterBaseFeature
from profanityfilter_sdk.features import _has_feature, _make_feature
...
class ProfanityFilterSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ProfanityFilterUtility()
    ...
    def get_utility(self):
        return ProfanityFilterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ProfanityFilterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Containsprofanity(self, data=None) -> "ContainsprofanityEntity":
        ...
        from profanityfilter_sdk.entity.containsprofanity_entity import ContainsprofanityEntity
