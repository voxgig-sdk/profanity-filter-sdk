...
from profanityfilter_sdk.profanityfilter_types import (
    Containsprofanity,
    ContainsprofanityLoadMatch,
)
...
class ContainsprofanityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContainsprofanityEntity(self._client, opts)
    ...
    def data_get(self) -> Containsprofanity:
    ...
    def match_get(self) -> Containsprofanity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Containsprofanity:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Containsprofanity().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
