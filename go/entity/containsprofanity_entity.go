...
type ContainsprofanityEntity struct {
	name    string
...
func NewContainsprofanityEntity(client *core.ProfanityFilterSDK, entopts map[string]any) *ContainsprofanityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContainsprofanityEntity) GetName() string { return e.name }
...
func (e *ContainsprofanityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContainsprofanityEntity) Deleted() bool {
	return e.deleted
}


func (e *ContainsprofanityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContainsprofanityEntity(e.client, opts)
}

func (e *ContainsprofanityEntity) Data(args ...any) any {
...
func (e *ContainsprofanityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Containsprofanity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContainsprofanityEntity) DataTyped(data ...Containsprofanity) Containsprofanity {
	if len(data) > 0 {
		return typedFrom[Containsprofanity](e.Data(asMap(data[0])))
	}
	return typedFrom[Containsprofanity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Containsprofanity (all fields
// optional at the wire level).
func (e *ContainsprofanityEntity) MatchTyped(match ...Containsprofanity) Containsprofanity {
	if len(match) > 0 {
		return typedFrom[Containsprofanity](e.Match(asMap(match[0])))
	}
	return typedFrom[Containsprofanity](e.Match())
}
...
func (e *ContainsprofanityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContainsprofanityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContainsprofanityLoadMatch and returns an Containsprofanity. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ContainsprofanityEntity) LoadTyped(reqmatch ContainsprofanityLoadMatch, ctrl map[string]any) (Containsprofanity, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Containsprofanity{}, err
	}
	return typedFrom[Containsprofanity](res), nil
}



func (e *ContainsprofanityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ContainsprofanityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContainsprofanityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContainsprofanityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContainsprofanityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
