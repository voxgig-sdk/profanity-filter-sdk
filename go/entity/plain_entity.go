...
func NewPlainEntity(client *core.ProfanityFilterSDK, entopts map[string]any) *PlainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlainEntity) GetName() string { return e.name }
...
func (e *PlainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlainEntity) Deleted() bool {
	return e.deleted
}


func (e *PlainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlainEntity(e.client, opts)
}

func (e *PlainEntity) Data(args ...any) any {
...
func (e *PlainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Plain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlainEntity) DataTyped(data ...Plain) Plain {
	if len(data) > 0 {
		return typedFrom[Plain](e.Data(asMap(data[0])))
	}
	return typedFrom[Plain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Plain (all fields
// optional at the wire level).
func (e *PlainEntity) MatchTyped(match ...Plain) Plain {
	if len(match) > 0 {
		return typedFrom[Plain](e.Match(asMap(match[0])))
	}
	return typedFrom[Plain](e.Match())
}
...
func (e *PlainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlainLoadMatch and returns an Plain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlainEntity) LoadTyped(reqmatch PlainLoadMatch, ctrl map[string]any) (Plain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Plain{}, err
	}
	return typedFrom[Plain](res), nil
}



func (e *PlainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PlainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
