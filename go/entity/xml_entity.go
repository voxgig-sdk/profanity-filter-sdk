...
func NewXmlEntity(client *core.ProfanityFilterSDK, entopts map[string]any) *XmlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *XmlEntity) GetName() string { return e.name }
...
func (e *XmlEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *XmlEntity) Deleted() bool {
	return e.deleted
}


func (e *XmlEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewXmlEntity(e.client, opts)
}

func (e *XmlEntity) Data(args ...any) any {
...
func (e *XmlEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Xml; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *XmlEntity) DataTyped(data ...Xml) Xml {
	if len(data) > 0 {
		return typedFrom[Xml](e.Data(asMap(data[0])))
	}
	return typedFrom[Xml](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Xml (all fields
// optional at the wire level).
func (e *XmlEntity) MatchTyped(match ...Xml) Xml {
	if len(match) > 0 {
		return typedFrom[Xml](e.Match(asMap(match[0])))
	}
	return typedFrom[Xml](e.Match())
}
...
func (e *XmlEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *XmlEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// XmlLoadMatch and returns an Xml. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *XmlEntity) LoadTyped(reqmatch XmlLoadMatch, ctrl map[string]any) (Xml, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Xml{}, err
	}
	return typedFrom[Xml](res), nil
}



func (e *XmlEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *XmlEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *XmlEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *XmlEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *XmlEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
