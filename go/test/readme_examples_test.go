...
const testSeed = `map[string]any{"entity": map[string]any{"containsprofanity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "json": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "xml": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
