...
type ProfanityFilterSDK struct {
	Mode     string
...
func (sdk *ProfanityFilterSDK) OptionsMap() map[string]any {
...
func (sdk *ProfanityFilterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ProfanityFilterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ProfanityFilterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ProfanityFilterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ProfanityFilterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ProfanityFilterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ProfanityFilterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ProfanityFilterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ProfanityFilterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ProfanityFilterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ProfanityFilterSDK {
	...
	sdk := NewProfanityFilterSDK(sdkopts)
	sdk.Mode = "test"
