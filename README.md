...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/profanity-filter` | `npm install @voxgig-sdk/profanity-filter` |
| Python | `voxgig-sdk-profanity-filter` | `pip install voxgig-sdk-profanity-filter` |
| PHP | `voxgig-sdk/profanity-filter` | `composer require voxgig-sdk/profanity-filter` |
| Golang | `github.com/voxgig-sdk/profanity-filter-sdk/go` | `go get github.com/voxgig-sdk/profanity-filter-sdk/go` |
| Ruby | `voxgig-sdk-profanity-filter` | `gem install voxgig-sdk-profanity-filter` |
| Lua | `voxgig-sdk-profanity-filter` | `luarocks install voxgig-sdk-profanity-filter` |
